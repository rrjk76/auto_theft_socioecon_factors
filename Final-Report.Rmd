...
Finally, the combined census dataset was merged with the Auto Theft dataset. I merged them using twk key attributes: 
...
In Table 3, we can see that using the training data, there is an increase in the total number of auto thefts between 2015 and 2020. On the contrary, the average income remains rather the stagnant, with a slight decrease from $49,183 in 2015 to \$49,095 in 2020. We do see, however, see that there is a surge in the unemployment rate, rising sharply from 8.62% in 2015 to 14.58% in 2020. This is likely influenced by the economic disruptions from the COVID-19 pandemic, and I will take this into account for this analysis. Finally, Table 3 shows us that the percentage of the population classified as low-income declined from 19.61% to 12.15%, suggesting potential improvements in economic conditions for some groups.
...
For the 65+ age group, the correlation is -0.069, suggesting neighbourhoods with more seniors experience slightly fewer auto thefts, though this relationship is rather weak.
...
I also explored the relationship between different housing types, such as duplexes, high-rises (over 5 storeys), low-rises (under 5 storeys), semi-detached houses, single-detached houses, and row houses with auto theft incidents. I created interactive scatterplots for each, which are available under the Interactive Visualizations tab on my website listed under the subsetction Housing Plots. Figure 6 below shows a snapshot focusing specifically on the number of duplexes in neighbourhoods compared to the number of auto thefts.
